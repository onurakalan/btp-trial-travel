CLASS zcl_oa_travel_gen_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_oa_travel_gen_data IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.


    DATA itab TYPE TABLE OF zoa_travel_001.
...
*   delete existing entries in the database table
    DELETE FROM zoa_travel_001.

*   insert the new table entries
    INSERT zoa_travel_001 FROM TABLE @itab.
